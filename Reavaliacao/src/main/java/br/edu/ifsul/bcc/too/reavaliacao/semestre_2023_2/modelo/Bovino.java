...
public class Bovino {
    ...
    public String setData_fim_string(String data_fim) {
     ...
     return "ID: "+ getId()+ " Valor liquido: "+ getValor_liquido() + " Data inicio: "+sdf.format(getData_inicio().getTime())+ " Data fim: "+sdf.format(getData_fim().getTime())+ ", Peso chegada: "+getPeso_chegada()+ ", Peso atual: "+getPeso_atual()+ ", Custo diario: "+getCusto_diario()+
             ", Valor kg compra: "+ getValor_kg_compra()+ ", Valor kg venda: "+ getValor_kg_venda()+ ", Raça: "+ getRaca()+", Situação:"+getSituacao();
     }
}
